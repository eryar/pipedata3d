...
#
# Script for the Concentric Reducer of ASME B16.9-2012.
# 
...
set aDescription "Concentric Reducer"
...
proc buildModel {theDimension} {
    ...
    pcone aReducer [expr $lo/2] [expr $so/2] $h
    ...
    vpoint p1 0 0 0
    vpoint p2 0 0 $h
    vdimension dim1 -length -plane zox -shapes p1 p2 -flyout $so -color black -value $h
    
    vdimension dim2 -diameter -plane xoy -shapes E1_1 -flyout $so -color black -value $so
    vdimension dim3 -diameter -plane xoy -shapes E1_3 -flyout $so -color black -value $lo
}